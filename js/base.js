...
function gameOver () {
	...
	resultLayer.graphics.drawRoundRect(3, "#bbb", [0, 0, 350, 350, 5], true,"#ddd");
	...
	usedStepsTxt.lineColor = "#555";
	usedStepsTxt.color = "#fff";
